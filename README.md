...
![График использования памяти](/docs/images/memory_usage_example.png)

![График использования памяти](/docs/images/home_page_plate_example.png)

![График использования памяти](/docs/images/cpu_usage_example.png)
...
Если у вас не хватает каких-либо зависимостей, вы можете их доустановить или создать для приложения отдельное виртуальное окружение:
```
python3 -m venv ./.venv
...
Перед запуском основной программы убедитесь, что у вас настроен сервер postgresql. Вы можете прочитать инструкции по установке и настройке
PostgreSQL и TimescaleDB в каталоге __docs__ или обратитесь к data base administrator вашей компании. Инструкции по настройке кластера 
postgresql вы можете найти в файле [postgresql.md](/docs/postgres.md), а по настройке базы данных в [timescale.md](/docs/timescaledb.md).
...
Если все зависимости установлены, вы можете просто запустить скрипт _main.py_ на том хосте, где запущены ваши докер-контейнеры
```
python3 main.py
```
...
web-часть приложения и посмотреть статистику вы можете прочитать в [webapp/README.md](/webapp/README.md)

## Описание структуры базы данных

Более подробно о структуре базы можно почитать в [соответствующей документации](/docs/database_description.md)